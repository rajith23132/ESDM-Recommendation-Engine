...
with tab3:
    ...
    # Only show details when "Show Details" button is clicked
    if selected_profile:
        selected_id = None
        for p in all_products:
        ...
        if selected_id:
            ...
            show_details = st.button("🔍 Show Product Details",use_container_width=True) 
            ...
            if show_details:
                ...
                if selected_product:
                    ...
                    with cols[1]:
                        ...
                        # Technical specs in bullet points
                        tech_specs = [
